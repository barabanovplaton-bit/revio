    ...
    >
      ...
      <div className="shrink-0 p-2">
        {isAuthed ? (
          ...
          // Не залогинен
          collapsed ? (
            // Свёрнутый: БЕЛАЯ круглая иконка плюсика (как кнопка Новый проект)
            <div className="flex justify-center">
              <button
                type="button"
                onClick={onSignInClick}
                title="Попробовать бесплатно"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-text-primary text-bg-page transition-all hover:opacity-90 active:scale-[0.95]"
              >
                <PlusIcon className="h-4 w-4" />
              </button>
            </div>
